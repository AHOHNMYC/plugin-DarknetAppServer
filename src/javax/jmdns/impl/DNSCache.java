...
public class DNSCache extends AbstractMap<String, List<? extends DNSEntry>> {
    ...
    private transient Set<Entry<String, List<? extends DNSEntry>>> _entrySet  = null;
     ...
     *
     */
    protected static class _CacheEntry extends Object implements Entry<String, List<? extends DNSEntry>> {
    ...
    public DNSCache(int initialCapacity) {
        super();
        _entrySet = new HashSet<Entry<String, List<? extends DNSEntry>>>(initialCapacity);
    }
    ...
    public Set<Entry<String, List<? extends DNSEntry>>> entrySet() {
        if (_entrySet == null) {
            _entrySet = new HashSet<Entry<String, List<? extends DNSEntry>>>();
        }
        return _entrySet;
    }
    ...
    protected Entry<String, List<? extends DNSEntry>> getEntry(String key) {
        ...
        for (Entry<String, List<? extends DNSEntry>> entry : this.entrySet()) {
            if (stringKey != null) {
    ...
    public List<? extends DNSEntry> put(String key, List<? extends DNSEntry> value) {
        synchronized (this) {
            ...
            Entry<String, List<? extends DNSEntry>> oldEntry = this.getEntry(key);
            if (oldEntry != null) {
    ...
    public synchronized boolean addDNSEntry(final DNSEntry dnsEntry) {
        ...
        if (dnsEntry != null) {
            Entry<String, List<? extends DNSEntry>> oldEntry = this.getEntry(dnsEntry.getKey());
    ...
    public synchronized boolean removeDNSEntry(DNSEntry dnsEntry) {
        boolean result = false;
        if (dnsEntry != null) {
            Entry<String, List<? extends DNSEntry>> existingEntry = this.getEntry(dnsEntry.getKey());
    ...
    public synchronized boolean replaceDNSEntry(DNSEntry newDNSEntry, DNSEntry existingDNSEntry) {
        ...
        if ((newDNSEntry != null) && (existingDNSEntry != null) && (newDNSEntry.getKey().equals(existingDNSEntry.getKey()))) {
            Entry<String, List<? extends DNSEntry>> oldEntry = this.getEntry(newDNSEntry.getKey());
